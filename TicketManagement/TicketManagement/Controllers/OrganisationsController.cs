...
namespace TicketManagement.Controllers
{
    public class OrganisationsController : Controller
    {
        ...
        {
            ViewBag.ContactUserId = new SelectList(db.UserExtras, "Id", "ApplicationUserId");
            return View();
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,IsInternal,ContactUserId,LastUpdated")] Organisation organisation)
        {
            ...
            ViewBag.ContactUserId = new SelectList(db.UserExtras, "Id", "ApplicationUserId", organisation.ContactUserId);
            return View(organisation);
        }
